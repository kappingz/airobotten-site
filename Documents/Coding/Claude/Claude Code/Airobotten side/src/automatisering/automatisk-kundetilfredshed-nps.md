...
meta_description: "Mål kundetilfredsheden automatisk med NPS-surveys på det rigtige tidspunkt. Saml feedback og forbedr kundeoplevelsen løbende."
...
result: ""
problem: |
  <p>Du maaler ikke systematisk kundetilfredshed, og når du goer det sker det manuelt og inkonsistent.</p>
...
solution: |
  <p>Vi bygger et flow der automatisk sender NPS-undersoegelser efter koeb eller projektafslutning, samler svarene, og genererer AI-analyserede indsigter.</p>
...
steps:
  - title: ""
    body: "Ingen polling, ingen manuel handling — Typeform er konfigureret til at notificere Make.com i realtid, så der aldrig opstår forsinkelse mellem hændelsen og den automatiske behandling."
