...
solution: |
  <p>Vi bygger et flow der automatisk genererer en moedeagenda baseret på deltageliste, tidligere moedereferater og aktuelle projektstatus med AI.</p>
  <p>Opsætningen sker én gang. Herefter kører flowet autonomt — 24 timer i døgnet, 7 dage om ugen — og sikrer at  inden for 44 sekunder uanset tidspunkt. Du behøver ikke at huske det, planlægge det eller følge op på det.</p>
tools:
  - "Google Calendar"
  - "Make.com"
  - "OpenAI"
...
steps:
  - title: ""
    body: "Ingen polling, ingen manuel handling — Google Calendar er konfigureret til at notificere Make.com i realtid, så der aldrig opstår forsinkelse mellem hændelsen og den automatiske behandling."
  - title: "Data valideres og renses"
    body: "Make.com modtager alle relevante felter fra Google Calendar og validerer dem: er alle påkrævede felter til stede? Er dataformatet korrekt? Mangler der noget, markeres posten til manuel gennemgang og du notificeres — korrekte poster sendes videre."
...
faq_items:
  ...
  - q: "Hvad sker der, hvis Google Calendar eller Make.com er midlertidigt utilgængeligt?"
    a: "Make.com har indbygget retry-logik: hvis Google Calendar eller Make.com er utilgængeligt, forsøger flowet igen automatisk med eksponentiel backoff. Data går aldrig tabt — de sættes i kø og behandles, så snart forbindelsen er reetableret. Du modtager en notifikation, hvis der opstår et problem der kræver din opmærksomhed."
mini_case:
...
before_cta: |
  ...
  <p>Se også: <a href="/branche/ai-automatisering-konsulenter/">AI-automatisering til konsulentfirmaer</a> og <a href="/sammenligning/monday-vs-asana-danmark/">Monday.com vs Asana</a>.</p>
related:
...
faq_schema: |
  {
    ...
    "mainEntity":[
      ...
      {"@type":"Question","name":"Hvad sker der, hvis Google Calendar eller Make.com er midlertidigt utilg\u00e6ngeligt?","acceptedAnswer":{"@type":"Answer","text":"Make.com har indbygget retry-logik: hvis Google Calendar eller Make.com er utilg\u00e6ngeligt, fors\u00f8ger flowet igen automatisk med eksponentiel backoff. Data g\u00e5r aldrig tabt \u2014 de s\u00e6ttes i k\u00f8 og behandles, s\u00e5 snart forbindelsen er reetableret. Du modtager en notifikation, hvis der opst\u00e5r et problem der kr\u00e6ver din opm\u00e6rksomhed."}}
    ]
  }
---
