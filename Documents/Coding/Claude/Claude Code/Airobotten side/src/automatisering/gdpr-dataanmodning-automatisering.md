...
result: ""
problem: |
  <p>Du modtager GDPR-anmodninger og skal manuelt soege på tvaers af systemer for at finde og slette kundedata.</p>
...
solution: |
  <p>Vi bygger et flow der automatisk soeger i alle relevante systemer når en GDPR-anmodning modtages, samler data, og genererer et svar.</p>
  <p>Opsætningen sker én gang. Herefter kører flowet autonomt — 24 timer i døgnet, 7 dage om ugen — og sikrer at  inden for 42 sekunder uanset tidspunkt. Du behøver ikke at huske det, planlægge det eller følge op på det.</p>
tools:
  - "Make.com"
  - "Gmail"
  - "HubSpot"
...
steps:
  ...
  - title: "Data valideres og renses"
    body: "Dataene normaliseres: datoformater, valutaer, tegnkodning og feltlængder tilpasses præcis det format som Gmail forventer. Det eliminerer de klassiske kompatibilitetsproblemer der opstår, når to systemer taler lidt forskelligt sprog."
  - title: "Behandling og transformation"
    body: "Her sker den centrale behandling: beregninger, opslag i andre systemer, formatering og eventuel berigelse af data med ekstra information fra Gmail eller andre kilder."
  - title: ""
...
faq_items:
  ...
  - q: "Hvad sker der, hvis Make.com eller Gmail er midlertidigt utilgængeligt?"
    a: "Make.com har indbygget retry-logik: hvis Make.com eller Gmail er utilgængeligt, forsøger flowet igen automatisk med eksponentiel backoff. Data går aldrig tabt — de sættes i kø og behandles, så snart forbindelsen er reetableret. Du modtager en notifikation, hvis der opstår et problem der kræver din opmærksomhed."
...
faq_schema: |
  {
    ...
    "mainEntity":[
      ...
      {"@type":"Question","name":"Hvad sker der, hvis Make.com eller Gmail er midlertidigt utilg\u00e6ngeligt?","acceptedAnswer":{"@type":"Answer","text":"Make.com har indbygget retry-logik: hvis Make.com eller Gmail er utilg\u00e6ngeligt, fors\u00f8ger flowet igen automatisk med eksponentiel backoff. Data g\u00e5r aldrig tabt \u2014 de s\u00e6ttes i k\u00f8 og behandles, s\u00e5 snart forbindelsen er reetableret. Du modtager en notifikation, hvis der opst\u00e5r et problem der kr\u00e6ver din opm\u00e6rksomhed."}},
