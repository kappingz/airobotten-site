...
result: ""
problem: |
  <p>Kunder ringer eller mailer for at få et tilbud, og du bruger tid på at beregne priser manuelt.</p>
...
solution: |
  <p>Vi bygger en formular der fanger kundens specifikationer, koerer dem igennem en prisberegning, og sender et professionelt tilbud direkte til kunden.</p>
...
steps:
  ...
  - title: "Data valideres og renses"
    body: "Make.com modtager alle relevante felter fra Typeform og validerer dem: er alle påkrævede felter til stede? Er dataformatet korrekt? Mangler der noget, markeres posten til manuel gennemgang og du notificeres — korrekte poster sendes videre."
...
before_cta: |
  ...
  <p>Se også: <a href="/kan-man/kan-man-automatisere-prisberegning/">Kan man automatisere prisberegning?</a>, <a href="/kan-man/kan-man-automatisere-tilbudsgivning-haandvaerker/">Kan man automatisere tilbudsgivning som håndværker?</a>, <a href="/branche/ai-automatisering-toemrere/">AI-automatisering til tømrere</a> og <a href="/branche/ai-automatisering-arkitekter/">AI-automatisering til arkitekter</a>.</p>
related:
