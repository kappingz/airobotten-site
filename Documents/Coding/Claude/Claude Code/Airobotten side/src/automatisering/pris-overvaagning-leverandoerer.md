...
result: ""
problem: |
  <p>Du tjekker manuelt leverandoerers prislister. Det er tidskraevende og du misser ofte gunstige priser.</p>
...
solution: |
  <p>Vi sætter et flow op der regelmaessigt tjekker dine leverandoerers priser og sender dig en alert når priserne aendrer sig.</p>
