...
result: ""
problem: |
  <p>Du håndterer abonnementsfornyelser manuelt og mister kunder fordi du glemmer at følge op.</p>
...
solution: |
  <p>Vi bygger et flow der sender påmindelser foer fornyelse, håndterer betaling, og sender bekraeftelse. Ved fejlet betaling startes en automatisk win-back-sekvens.</p>
...
before_cta: |
  ...
  <p>Se også: <a href="/kan-man/kan-man-automatisere-abonnementer/">Kan man automatisere abonnementsstyring?</a></p>
related:
