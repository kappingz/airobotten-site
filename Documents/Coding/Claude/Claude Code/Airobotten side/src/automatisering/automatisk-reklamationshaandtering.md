...
solution: |
  <p>Vi bygger et flow der modtager reklamationer via formular, opretter en sag, tildeler den til den rette person, og tracker den til loesning.</p>
...
steps:
  - title: ""
    body: "Flowet aktiveres øjeblikkeligt, uden forsinkelse og uden at du skal gøre noget. Typeform sender automatisk et signal til Make.com via webhook eller API-integration."
