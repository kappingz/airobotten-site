...
result: ""
problem: |
  <p>Du samler kvitteringer og bruger timer på at taste dem ind manuelt ved maanedens afslutning.</p>
...
solution: |
  <p>Vi bygger et flow hvor du sender et foto af kvitteringen til Slack. AI aflaeser beløb og opretter automatisk en udgiftspost i dit regnskabssystem.</p>
