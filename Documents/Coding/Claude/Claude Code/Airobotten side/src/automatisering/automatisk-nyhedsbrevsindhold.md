...
meta_description: "Lad AI generere engagerende nyhedsbrevsindhold på autopilot. Konsistente og relevante nyhedsbreve uden timer bag tastaturet."
...
result: ""
problem: |
  <p>Du har ikke tid til at skrive nyhedsbreve konsistent og ender med at springe over.</p>
...
solution: |
  <p>Vi bygger et flow der samler dine seneste blogindlaeg, produktnyheder og branchenyheder, genererer et nyhedsbrev med AI, og sender det via dit email-system.</p>
...
steps:
  ...
  - title: ""
    body: "Den automatiske handling i ActiveCampaign er identisk med hvad du selv ville gøre manuelt — bare hurtigere, mere konsekvent og uden mulighed for tastfejl.  på rekordtid."
