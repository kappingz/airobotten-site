...
solution: |
  <p>Vi bygger et flow der analyserer subscribers koebshistorik og engagement med AI, tildeler segmenter, og opdaterer dine email-lister automatisk.</p>
  <p>Opsætningen sker én gang. Herefter kører flowet autonomt — 24 timer i døgnet, 7 dage om ugen — og sikrer at  inden for 36 sekunder uanset tidspunkt. Du behøver ikke at huske det, planlægge det eller følge op på det.</p>
tools:
  - "Klaviyo"
  - "Make.com"
  - "OpenAI"
steps:
  - title: ""
    body: "Flowet aktiveres øjeblikkeligt, uden forsinkelse og uden at du skal gøre noget. Klaviyo sender automatisk et signal til Make.com via webhook eller API-integration."
  - title: "Data valideres og renses"
    body: "Make.com modtager alle relevante felter fra Klaviyo og validerer dem: er alle påkrævede felter til stede? Er dataformatet korrekt? Mangler der noget, markeres posten til manuel gennemgang og du notificeres — korrekte poster sendes videre."
...
benefits:
  ...
  - "Real-time synkronisering: data i Klaviyo afspejles øjeblikkeligt uden manuel opdatering"
