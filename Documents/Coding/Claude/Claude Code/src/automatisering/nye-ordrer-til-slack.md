...
result: ""
problem: |
  <p>Du eller dit team tjekker manuelt Shopify eller jeres email for nye ordrer og kopierer ordreinfo over i Slack. Det tager tid, og nogle gange bliver ordrer overset.</p>
...
solution: |
  <p>Vi bygger et automatiseret flow i Make.com der lytter efter nye ordrer i din webshop og sender en formateret besked til en Slack-kanal med kundenavn, ordrebeloeb og produkter. Dit team får besked i realtid.</p>
...
related:
  - url: "/automatisering/automatisk-ordrebekraeftelse-email/"
    ...
    category: "E-commerce"
  - url: "/automatisering/ai-produktbeskrivelser-webshop/"
