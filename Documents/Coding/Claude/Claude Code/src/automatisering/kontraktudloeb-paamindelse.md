...
result: ""
problem: |
  <p>Du har kontrakter der automatisk fornyes. Du glemmer at genforhandle i tide.</p>
...
solution: |
  <p>Vi bygger et system der tracker alle dine kontrakter og sender automatiske påmindelser 90, 60 og 30 dage foer udloeb.</p>
...
steps:
  - title: ""
    body: "Triggeren er pålidelig og fejltolerant: hvis Google Sheets midlertidigt er utilgængeligt, sættes hændelsen i kø og behandles, så snart forbindelsen er genetableret."
  - title: "Data valideres og renses"
    body: "Make.com modtager alle relevante felter fra Google Sheets og validerer dem: er alle påkrævede felter til stede? Er dataformatet korrekt? Mangler der noget, markeres posten til manuel gennemgang og du notificeres — korrekte poster sendes videre."
