...
result: ""
problem: |
  <p>Du opretter og sender fakturaer manuelt. Det tager tid og forsinker din cash flow.</p>
...
solution: |
  <p>Vi bygger et flow der automatisk opretter fakturaer i Invoice Ninja når en deal lukkes, et projekt afsluttes, eller en ordre registreres.</p>
  <p>Opsætningen sker én gang. Herefter kører flowet autonomt — 24 timer i døgnet, 7 dage om ugen — og sikrer at  inden for 17 sekunder uanset tidspunkt. Du behøver ikke at huske det, planlægge det eller følge op på det.</p>
tools:
  - "Invoice Ninja"
  - "Make.com"
  - "HubSpot"
steps:
  - title: ""
    body: "Flowet aktiveres øjeblikkeligt, uden forsinkelse og uden at du skal gøre noget. Invoice Ninja sender automatisk et signal til Make.com via webhook eller API-integration."
...
benefits:
  ...
  - "Real-time synkronisering: data i Invoice Ninja afspejles øjeblikkeligt uden manuel opdatering"
...
faq_items:
  ...
  - q: "Hvad sker der, hvis Invoice Ninja eller Make.com er midlertidigt utilgængeligt?"
    a: "Make.com har indbygget retry-logik: hvis Invoice Ninja eller Make.com er utilgængeligt, forsøger flowet igen automatisk med eksponentiel backoff. Data går aldrig tabt — de sættes i kø og behandles, så snart forbindelsen er reetableret. Du modtager en notifikation, hvis der opstår et problem der kræver din opmærksomhed."
...
faq_schema: |
  {
    ...
    "mainEntity":[
      ...
      {"@type":"Question","name":"Hvad sker der, hvis Invoice Ninja eller Make.com er midlertidigt utilg\u00e6ngeligt?","acceptedAnswer":{"@type":"Answer","text":"Make.com har indbygget retry-logik: hvis Invoice Ninja eller Make.com er utilg\u00e6ngeligt, fors\u00f8ger flowet igen automatisk med eksponentiel backoff. Data g\u00e5r aldrig tabt \u2014 de s\u00e6ttes i k\u00f8 og behandles, s\u00e5 snart forbindelsen er reetableret. Du modtager en notifikation, hvis der opst\u00e5r et problem der kr\u00e6ver din opm\u00e6rksomhed."}},
