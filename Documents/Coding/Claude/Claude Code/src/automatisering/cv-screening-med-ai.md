...
result: ""
problem: |
  <p>Du modtager 50+ ansoegninger per stilling og bruger timer på at gennemlaese CV'er.</p>
...
solution: |
  <p>Vi bygger et flow der modtager ansoegninger, sender CV'et til AI med din jobprofil som kontekst, og returnerer en vurdering med score i et Google Sheet.</p>
...
benefits:
  ...
  - "Spar 6–8 timer om ugen der tidligere gik til timer på administration"
