...
solution: |
  <p>Vi bygger et flow der indsamler priser fra dine leverandoerer, sammenligner dem automatisk, og giver dig en rapport med den bedste pris per produkt.</p>
