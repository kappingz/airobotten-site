...
result: ""
problem: |
  <p>Du får leads via LinkedIn men glemmer at tilføje dem til dit CRM, eller goer det for sent.</p>
...
solution: |
  <p>Vi bygger et flow der fanger nye LinkedIn-forbindelser eller beskeder, beriger dem med data, og opretter dem som leads i dit CRM.</p>
...
steps:
  - title: ""
    body: "Ingen polling, ingen manuel handling — LinkedIn er konfigureret til at notificere Make.com i realtid, så der aldrig opstår forsinkelse mellem hændelsen og den automatiske behandling."
...
faq_items:
  ...
  - q: "Hvad sker der, hvis LinkedIn eller Make.com er midlertidigt utilgængeligt?"
    a: "Make.com har indbygget retry-logik: hvis LinkedIn eller Make.com er utilgængeligt, forsøger flowet igen automatisk med eksponentiel backoff. Data går aldrig tabt — de sættes i kø og behandles, så snart forbindelsen er reetableret. Du modtager en notifikation, hvis der opstår et problem der kræver din opmærksomhed."
mini_case:
  title: "BrandHuset: Fra manuel rutine til automatisk flow"
  body: |
    <p>BrandHuset er et performance-marketingbureau med tre account managers. Manuelt at opdatere CRM, flytte leads og skrive opfølgningsmails kostede account manageren 6 timer om ugen — tid der ellers kunne bruges på opgaver der rent faktisk kræver menneskelig vurdering. Problemet var ikke mangel på vilje, men at processen simpelthen ikke var bygget til at køre automatisk.</p>
...
faq_schema: |
  {
    ...
    "mainEntity":[
      ...
      {"@type":"Question","name":"Hvad sker der, hvis LinkedIn eller Make.com er midlertidigt utilg\u00e6ngeligt?","acceptedAnswer":{"@type":"Answer","text":"Make.com har indbygget retry-logik: hvis LinkedIn eller Make.com er utilg\u00e6ngeligt, fors\u00f8ger flowet igen automatisk med eksponentiel backoff. Data g\u00e5r aldrig tabt \u2014 de s\u00e6ttes i k\u00f8 og behandles, s\u00e5 snart forbindelsen er reetableret. Du modtager en notifikation, hvis der opst\u00e5r et problem der kr\u00e6ver din opm\u00e6rksomhed."}}
    ]
  }
---
