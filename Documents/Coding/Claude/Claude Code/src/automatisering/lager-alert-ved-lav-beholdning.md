...
result: ""
problem: |
  <p>Du opdager for sent at populaere produkter er udsolgt. Det koster salg og frustrerer kunder.</p>
...
solution: |
  <p>Vi sætter et flow op der dagligt tjekker din lagerbeholdning og sender en alert til Slack eller email når et produkt rammer en minimumsgraense.</p>
