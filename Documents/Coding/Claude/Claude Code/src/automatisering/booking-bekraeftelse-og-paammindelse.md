...
result: ""
problem: |
  <p>Du sender manuelt bekraeftelser når kunder booker, og glemmer ofte at sende påmindelser. Det foerer til no-shows.</p>
...
solution: |
  <p>Vi bygger et flow der automatisk sender bekraeftelses-email ved ny booking, påmindelse 24 timer foer, og opfølgning efter moedet.</p>
  <p>Flowet er bygget til at håndtere edge cases og undtagelser: tomme felter, duplikater, uventede dataformater og netværksfejl behandles alle kontrolleret, så du aldrig ender med halvfærdige poster i Gmail. Fejlhåndteringen er tænkt ind fra starten, ikke tilføjet som eftertanke.</p>
tools:
  - "Calendly"
  - "Make.com"
  - "Gmail"
steps:
  - title: ""
    body: "Ingen polling, ingen manuel handling — Calendly er konfigureret til at notificere Make.com i realtid, så der aldrig opstår forsinkelse mellem hændelsen og den automatiske behandling."
