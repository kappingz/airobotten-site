...
result: ""
problem: |
  <p>Kunder laegger produkter i kurven men gennemfoerer ikke koebet. Du mister omsaetning.</p>
...
solution: |
  <p>Vi bygger et flow der sender en personlig SMS 1 time efter en forladt kurv, med et link direkte tilbage til deres kurv.</p>
  <p>Opsætningen sker én gang. Herefter kører flowet autonomt — 24 timer i døgnet, 7 dage om ugen — og sikrer at  inden for 39 sekunder uanset tidspunkt. Du behøver ikke at huske det, planlægge det eller følge op på det.</p>
tools:
  - "Shopify"
  - "Make.com"
  - "Twilio"
steps:
  ...
  - title: ""
    body: "Den automatiske handling i Twilio er identisk med hvad du selv ville gøre manuelt — bare hurtigere, mere konsekvent og uden mulighed for tastfejl.  på rekordtid."
